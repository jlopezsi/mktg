...
bank <- read.csv("bbbclub/bank.csv", sep = ";", stringsAsFactors = FALSE)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_age_lattice.pdf", 
...
pdf(file = "bbbclub/bank_fig_targeting_customers_education_mosaic.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_jobtype_mosaic.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_marital_mosaic.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_default_mosaic.pdf", 
    width = 8.5, height = 8.5)
...
# ------------------------------------------
# examine relationship between age and response to promotion
pdf(file = "bbbclub/bank_fig_targeting_customers_balance_lattice.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_housing_mosaic.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_loan_mosaic.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customer_log_reg_density_evaluation.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_confusion_mosaic_10_percent.pdf", 
    width = 8.5, height = 8.5)
...
pdf(file = "bbbclub/bank_fig_targeting_customers_lift_chart.pdf", 
    width = 8.5, height = 8.5)
plot(bankwork_lift, 
