...
1. diferentes algoritmos de clasificación producen diferentes resultados e incluso e con diferentes condiciones iniciales o distintos niveles de precisión pueden llegar a producir diferentes resultados (Hoek, Gendall and Esslemont 1996); Funkhouser 1983),
...
```
##predicción de la pertenencia a un segmento con un conjunto nuevo de datos
