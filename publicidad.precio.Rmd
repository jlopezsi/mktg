---
title: "Análisis de datos para la toma de decisiones de precios en el entorno R"
...
En este artículo, vamos a presentar cómo utilizar R para llevar a cabo algunos análisis básicos para la toma de decisiones comercialización basadas en evidencia, y luego aplicaremos el análisis en Oracle R Enterprise que integra el R con la  base de datos Oracle.
...
4. ¿Cómo encontrar el mejor precio unitario del jugo de uva que puede maximizar el beneficio y la previsión de ventas con ese precio.
...
Calculemos ahorael CPE en el zumo de manzana y galletas para analizar la forma en que el cambio de manzana precio jugo y galletas influencia el precio de las ventas de jugo de uva.
...
La CPEapple indica que 10% de disminución en los precios del  zumo de manzana disminuirá las ventas en un 7,8%, y viceversa. Así que el zumo de uva y zumo de manzana son sustitutos.
Las CPEcookies indica que 10% de disminución en el precio de las cookies aumentará las ventas en un 11,2%, y viceversa. Así que el zumo de uva y las galletas son complementarios. Coloque los dos productos juntos y es probable que aumente las ventas de ambos.
...
En general, las empresas quieren alcanzar beneficios más altos y no sólo mayor cantidad de ventas. Así que, ¿cómo se establece el precio óptimo para el nuevo zumo de uva para obtener el máximo beneficio basado en el conjunto de datos recolectados en el periodo de prueba y el modelo de regresión anterior?
...
El precio óptimo es 10.04; la ganancia máxima será de 1301 de acuerdo con el resultado anterior. En realidad, podemos establecer razonablemente el precio para ser 10 o 9.99<-..
Además podemos utilizar el modelo para predecir las ventas, mientras el precio sea 10.
